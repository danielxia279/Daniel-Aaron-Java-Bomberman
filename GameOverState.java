...
public class GameOverState extends StateTemplate {
    ...
    private int winner;
    private BufferedImage p1win1, p1win2, p1win3, p2win1, p2win2, p2win3, tie1, tie2, tie3;
    ...
    public void draw(Graphics g) {
        ...
        if (winner == 1) {
            if (current == 0)
                g.drawImage(p1win1, 0, 0, null);
            else if (current == 1)
                g.drawImage(p1win2, 0, 0, null);
            else if (current == 2)
                g.drawImage(p1win3, 0, 0, null);
        } else if (winner == 2) {
            if (current == 0)
                g.drawImage(p2win1, 0, 0, null);
            else if (current == 1)
                g.drawImage(p2win2, 0, 0, null);
            else if (current == 2)
                g.drawImage(p2win3, 0, 0, null);
        } else if (winner == 3) {
            if (current == 0)
                g.drawImage(tie1, 0, 0, null);
            else if (current == 1)
                g.drawImage(tie2, 0, 0, null);
            else if (current == 2)
                g.drawImage(tie3, 0, 0, null);
        }
    }
